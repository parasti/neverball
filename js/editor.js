...
`;
    ...
    playMap: function() {
      ...
      if (!document.documentElement.classList.contains("in-game") || !Neverball.isRunning) { alert("Please click 'Play Now' and wait for the game to start before testing maps."); return; } Neverball._module.ccall("emscripten_play_test_map", null, ["string"], [mapText]);
    }
  };
